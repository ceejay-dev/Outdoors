...
$alugueres = $controller->recuperarSolicitacoesCliente($id);

$filtroOut = filter_input(INPUT_GET, 'ot');
$ot = isset($filtroOt) ? $filtroOt : NULL;

$estado = $controller->recuperarEstadoOutdoor($ot)
?>
<!--MEXER NESTA VIEW ALTERAR OS CONTROLLERS E FAZER O MÉTODO PARA LISTA AS SOLICITAÇÕES DO CLIENTE A PARTIR DO ID 
USE A VARIAVEL DE SESSÃO PARA FAZER ISSO 
-->
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body class="gestor-body">
        <table class="table table-hover table-striped w-50 m-auto h-25" style="text-align: center;">
            ...
            <caption style="caption-side:top; color: black; font-size: 25px;">Meu carrinho</caption>
            ...
            <tbody>
                <tr>
                    ...
                    foreach ($alugueres as $aluguer):
                        ...
                        <td><a type="button" class="btn btn-info mx-2" name="btn-finalizar" id="btn-finalizar" href = "carregarComprovativo.php?ot=<?php echo $ot; ?>">Finalizar</a></td>
            ...
            <tfoot>
                <tr>
                    <td style="text-align: center" colspan="1">
                        <a href="listaOutdoorsC.php"> <button type="button" class="btn btn-outline-danger mx-2" name="btn-voltar" id="btn-voltar">Voltar</button> </a>
                    </td>
                </tr>                
            </tfoot>
        </table>
