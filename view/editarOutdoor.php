            ...
            <tbody>
                <tr>
                    ...
                    foreach ($outdoors as $outdoor):
                        ...
                        <td> <button type="button" class="btn btn-info" name="btn-editar" onclick="location.href='editarOutdoor.php?ident=<?php echo $outdoor->getIdOutdoor(); ?>'">Editar</button> </td>
                </tr> 
                 <?php endforeach; ?>
            </tbody>
            <tfoot>
                <tr>
                    <td style="text-align: center" colspan="1">
                        <a href="homeGestor.php"> <button type="button" class="btn btn-outline-danger" name="btn-voltar">Voltar</button> </a>
                    </td>
                </tr>                
            </tfoot>
        </table>
