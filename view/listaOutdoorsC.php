                ...
                <tr>
                    ...
                    foreach ($outdoors as $outdoor):
                        ...
                        <td><?php echo $outdoor->getEstado(); ?></td>
                         <td> <button type="button" class="btn btn-info" onclick="location.href='alugarOutdoor.php?ot=<?php echo $outdoor->getIdOutdoor(); ?>'">Solicitar</button> </td>
                </tr> 
                 <?php endforeach; ?>
            </tbody>
            <tfoot>
                <tr>
                    <td style="text-align: center" colspan="1">
                        <a href="homeLogged.php"> <button type="button" class="btn btn-outline-danger" name="btn-voltar">Voltar</button> </a>
                    </td>
                </tr>                
            </tfoot>
        </table>
