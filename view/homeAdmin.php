...
<html>
    ...
    <body class="wallpaper">
        <header>
            <nav class="navbar navbar-expand-lg bg-body-tertiary navegaco h-25" aria-label="Ninth navbar example">
                <div class="container-xxl">
                    <a class="navbar-brand" href="#"><img class="brand-img me-auto" src="../content/img/logo.png" alt="alt"/></a>
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarsExample07XL" aria-controls="navbarsExample07XL" aria-expanded="false" aria-label="Toggle navigation">
                        <span class="navbar-toggler-icon"></span>
                    </button>
                    <div class="collapse navbar-collapse" id="navbarsExample07XL">
                        <ul class="navbar-nav me-auto mb-4 mb-lg-0">
                            <li class="nav-item"><a class=" nav-link active" href="trocarEmailAdmin.php">Trocar email</a></li>
                            <li class="nav-item"><a class=" nav-link active" href="ativarContas.php">Ativar clientes</a></li>
                            <li class="nav-item"><a class="nav-link active" href="./registerGest.php">Adicionar gestor</a></li>
                            <li class="nav-item"><a class="nav-link active" href="listaGestores.php">Listar gestor</a></li>
                            <li class="nav-item"><a class="nav-link active" href="apagarGestores.php">Apagar gestor</a></li>
                        </ul>
